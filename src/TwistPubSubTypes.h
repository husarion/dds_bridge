...
#ifndef _GEOMETRY_MSGS_MSG_TWIST_PUBSUBTYPES_H_
#define _GEOMETRY_MSGS_MSG_TWIST_PUBSUBTYPES_H_
...
#error Generated Twist is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
...
/*!
         ...
         * @ingroup TWIST
         */
class TwistPubSubType : public eprosima::fastrtps::TopicDataType
{
public:
    typedef Twist type;
...
#endif // _GEOMETRY_MSGS_MSG_TWIST_PUBSUBTYPES_H_